...
class MainClass:
    def __init__(self, cam_calib_path, udp_stream=False):
        ...
        self.save_data_path = r"D:\CMC\export_games\data.msgpack"
        self.second_data = r"F:\ptrial"
        _vals = os.listdir(self.second_data)
        self.second_data_path = os.path.join(self.second_data, str(len(_vals) + 1) + ".msgpack")
        self.second_file = open(self.second_data_path, 'wb')
    ...
    def camera_thread(self):
        ...
        while True:    
            ...
            if ret:
                ...
                decode_image = mp.packb(self.video_frame, default=mpn.encode)
                self.second_file.write(decode_image)
